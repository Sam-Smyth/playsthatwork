...
function enqueue_theme_scripts()
{
  ...
  wp_enqueue_script('gsap-4', get_stylesheet_directory_uri() . '/dist/DrawSVGPlugin.min.js', array('gsap'), false, true);
  ...
  wp_enqueue_script('theme-scripts', get_stylesheet_directory_uri() . '/dist/main.js', array('gsap', 'gsap-2', 'gsap-3', 'gsap-4', 'swiper-js'), false, true);
}
...
function limit_all_excerpts($excerpt)
{
...
add_filter('get_the_excerpt', 'limit_all_excerpts', 20);
